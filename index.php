...
<head>
    ...
    <h1 style="text-align: center;" class="mt-4">Weboard KMUTNB</h1>
    ...
    <table class="table table-striped">
        <?php
            ...
            while($row=$result->fetch()){
                ...
                if($_SESSION['role']=='a'){
                    echo "<td><a href=delete.php?id=$row[0]><button type=button class='btn btn-danger btn-sm'><i class='bi bi-trash'></i></button></a></td>";
                }
                echo "</tr>";
            }
            $conn=null;
            ...
            //     echo "<tr><td><a href=post.php?id=$i style=text-decoration:none>กระทู้ที่$i</a></td>";
                // if($_SESSION['role']=='a'){
                //     echo "<td><a href=delete.php?id=$i><button type=button class='btn btn-danger btn-sm'><i class='bi bi-trash'></i></button></a></td>";
                // }
            //     echo "</tr>";
            // }
       ?>
